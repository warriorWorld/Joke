    ...
    public void getWeather(String city, DisposableObserver<WeatherBean> observer) {
        Observable.zip(RetrofitUtil
                ...
                RetrofitUtil.getInstance(mContext)
                        ...
                        .subscribeOn(Schedulers.io())
                        .observeOn(Schedulers.io())
                , new BiFunction<WeatherTypeBean, WeatherBean, WeatherBean>() {
                    @Override
                    public WeatherBean apply(WeatherTypeBean weatherTypeBean, WeatherBean bean) throws Exception {
